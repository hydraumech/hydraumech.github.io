...
var mpopTimer = 0;
mcs='#000000';
mmenucolor='#ececec';mmenucolor1='#000000';mfontcolor1='#000000';mfontcolor='#ffffff';mmenuoutcolor='#F88B21';mmenuincolor='#F88B21';mmenuoutbordercolor='#F88B21';mmenuinbordercolor='#FF0000';mmidoutcolor='#F88B21';mmidincolor='#cccccc';mmenuovercolor='#cccccc';mitemedge='0';msubedge='1';mmenuunitwidth='';mmenuitemwidth=240;mmenuheight=25;mmenuwidth='100%';mmenuadjust=0;mmenuadjustV=0;mfonts='font-family: Arial, Helvetica, sans-serif; font-size: 12px;font-weight:bold; color: #000000; ';mcursor='hand';
var swipeSteps = 4;
var swipemsec = 25;
...
function mnochange1(src){
src.style.borderLeftColor=mmenucolor;
src.style.borderRightColor=mmenucolor;
src.style.borderTopColor=mmenucolor;
src.style.borderBottomColor=mmenucolor;
src.style.backgroundColor='';
src.style.color=mfontcolor1;
...
function mwritetodocument(){
      var mwb=0;
                     var stringx='<div id="mposflag" style="position:absolute;"></div><table  id=mmenutable border=0 cellpadding=3 cellspacing=2 width='+mmenuwidth+' height='+mmenuheight+' bgcolor='+mmenucolor1+
                     ...
                     for(var x=0;x<mmenus.length;x++){
                      thismenu=mmenus[x];
                        ...
                        stringx+=';border-left: 2px solid '+mmidoutcolor+
                      ...
                      '<table  width="80%" border="0" height="100%" align="left" cellpadding="0" cellspacing="2" '+
                      'style="'+mfonts+' border-left: 2px solid '+mmenuoutbordercolor;
                      if(mmenuinbordercolor!=mmenuoutbordercolor&&msubedge=="0"){
...
stringx+='<div id=msubmenudiv'+j+
                        ' style="filter:Alpha(Opacity=100);tag:'+thisitem.level+';cursor:'+mcursor+';position:absolute;'+
